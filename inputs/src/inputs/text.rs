...
pub fn InputText(
    ...
    #[prop(default = MaybeSignal::from(String::new()))] label: MaybeSignal<String>,
    ...
    #[prop(optional, into)] error_message: RwSignal<String>,
    /// The style to be applied to the input
    #[prop(default = TextInputStyle::Underline)] style: TextInputStyle
) -> impl IntoView {
